...
data class MountainDto(val mountain_id: Int, val mountain_code: Int, val mountainName: String, val mountain_location: String, val mountain_height: Int, val mountain_description: String, val mountain_img: String?, val mountain_weather: String, val mountain_lat: Double, val mountain_lon: Double, val mountain_spots: List<MountainSpot>)