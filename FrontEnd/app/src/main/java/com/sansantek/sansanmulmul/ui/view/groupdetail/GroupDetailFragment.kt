    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ibNoti.setOnClickListener {
            if (popupShow) {
                ...
                val popUpList = mutableListOf(Alarm("등산 일정 변경", "등산 일정이 24.07.18(목) 13:00 - 24.07.19(금) 14:00로 변경되었습니다"), Alarm("그룹 가입 요청", "nickname 님이 그룹 가입을 요청했습니다! 멤버 목록에서 수락 또는 거절할 수 있습니다"), Alarm("등산 코스 변경", "등산 코스가 가야산 / 가야산국립공원남산제일봉2코스로 변경되었습니다"))
