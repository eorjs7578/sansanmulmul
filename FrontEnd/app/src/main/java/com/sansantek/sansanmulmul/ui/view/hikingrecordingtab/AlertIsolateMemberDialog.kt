...
import com.sansantek.sansanmulmul.databinding.DialogRecordingIsolateBinding
import com.sansantek.sansanmulmul.ui.viewmodel.HikingRecordingTabViewModel

class AlertIsolateMemberDialog : DialogFragment() {
    // 뷰 바인딩 정의
    private var _binding: DialogRecordingIsolateBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogRecordingIsolateBinding.inflate(inflater, container, false)
        ...
        binding.btnClose.setOnClickListener {
            hikingRecordingTabViewModel.setIsAlertShow(false)
            dismiss()
        }
