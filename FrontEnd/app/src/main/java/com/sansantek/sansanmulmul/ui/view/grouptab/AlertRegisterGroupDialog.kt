...
class AlertRegisterGroupDialog : DialogFragment() {
    // 뷰 바인딩 정의
    private var _binding: DialogGroupRegisterBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = DialogGroupRegisterBinding.inflate(inflater, container, false)
