...
import com.sansantek.sansanmulmul.databinding.DialogStoneAddSuccessBinding
import com.sansantek.sansanmulmul.ui.view.MainActivity

class StoneAddSuccessDialog(val picturedImg: Bitmap) : DialogFragment() {

  private var _binding: DialogStoneAddSuccessBinding? = null
  ...
  override fun onCreateView(
    ...
    _binding = DialogStoneAddSuccessBinding.inflate(inflater, container, false)
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    binding.ivStonePictured.setImageBitmap(picturedImg)
