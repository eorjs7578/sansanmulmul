...
class ViewPagerFragment : BaseFragment<FragmentLoginViewPagerBinding>(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.nextButton.setOnClickListener {
            Log.d(TAG, "onViewCreated: ${binding.viewPager.currentItem} ${binding.viewPager.adapter!!.itemCount} ")
...
//                 회원가입 완료 페이지 나오기 바로 전 => 등산 스타일 정하는 페이지에서 다음 버튼을 눌렀을 때
                lifecycleScope.launch {
                    activityViewModel.setKakaoLoginUser(KakaoLoginUser(
                    ...
                    val result = userService.registerUser(activityViewModel.kakaoLoginUser)
