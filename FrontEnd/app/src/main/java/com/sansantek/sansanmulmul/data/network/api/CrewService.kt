...
interface CrewService {
  ...
  suspend fun createCrew(
    @Header("Authorization") accessToken: String,
    @Body crewCreateRequest: CreateCrew
  ): Response<String>
  ...
  suspend fun getCrewGalleryList(
    @Header("Authorization") accessToken: String,
    @Path("crewId") crewId: Int
  ): Response<List<CrewGallery>>

  @Multipart
  @POST("crew/detail/{crewId}/gallery")
  suspend fun postPictureToGallery(
    @Header("Authorization") accessToken: String,
    @Path("crewId") crewId: Int,
  ...
  suspend fun delegateLeader(
    @Header("Authorization") accessToken: String,
    @Path("crewId") crewId: Int,
    @Query("nextLeaderId") nextLeaderId: Int
  ): Response<String>
  ...
  suspend fun getRequestList(
    @Header("Authorization") accessToken: String,
    @Path("crewId") crewId: Int
  ): Response<List<RequestMember>>

  @PATCH("crew/{requestId}/refuse")
  suspend fun refuseRegister(
    @Header("Authorization") accessToken: String,
    @Path("requestId") requestId: Int
  ): Response<String>

  @PATCH("crew/{requestId}/accept")
  suspend fun acceptRegister(
    @Header("Authorization") accessToken: String,
    @Path("requestId") requestId: Int
  ): Response<String>

  @DELETE("crew/{crewId}/out")
  suspend fun exitCrew(
    @Header("Authorization") accessToken: String,
    @Path("crewId") crewId: Int
  ): Response<String>
